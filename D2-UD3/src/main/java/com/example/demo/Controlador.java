...
public class Controlador {
	...
	static String usuarioValido="Andres";
	static String contrseñaValida="contraseña";
	HashMap<String, String> Usuarios=new HashMap<>();
	
	@GetMapping("/")
	public String showForm(Model modelo,HttpSession sesion,HttpServletRequest request) {
		if(sesion.getAttribute(contrseñaValida)==null) {
			return "login";
		}else {
	...
	public String showForm1(Model modelo,HttpSession sesion,HttpServletRequest request) {
		if(sesion.getAttribute("contraseña")==null) {
			return "login";
		}else {
			return "form";
		}
	...
	public String logIn(@RequestParam(name="usuario")String usuario,@RequestParam(name="contraseña")String contraseña,
		...
		if(!contraseña.equals(contrseñaValida) || !usuario.equals(usuarioValido)) {
